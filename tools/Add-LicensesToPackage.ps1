param(
    ...
    [string]$PackagePath = (Join-Path $PSScriptRoot "..\..\..\LocalMapUpgrade-v3.1.0-MCM-AE-1.7.104.0.zip")
)
...
$docsRoot = Join-Path $tempRoot "Docs\Local Map Upgrade"
...
$required = @(
    ...
    "Docs/Local Map Upgrade/LICENSE",
    "Docs/Local Map Upgrade/NOTICE.md",
    "Docs/Local Map Upgrade/THIRD_PARTY_NOTICES.md",
    "Docs/Local Map Upgrade/licenses/LocalMapUpgrade-MIT.txt",
    "Docs/Local Map Upgrade/licenses/CommonLibSSE-NG-GPL-3.0-or-later.txt",
    "Docs/Local Map Upgrade/licenses/CommonLibSSE-NG-EXCEPTIONS.md",
    "Docs/Local Map Upgrade/licenses/SimpleIni-MIT.txt"
)
